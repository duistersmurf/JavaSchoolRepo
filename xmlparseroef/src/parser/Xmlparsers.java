...
public class Xmlparsers extends DefaultHandler {
   ...
   public void endElement( String namespaceURI,String localName,String qName ) throws SAXException {
	   ...
	   if ( getTagPath().equals( "/bookshelf/books/book/title" ) ) {
		   	books.addElement(" ");
	      ...
	      else if ( getTagPath().equals( "/bookshelf/books/book/language" ) ) {
	    	  books.addElement( " " + contents.toString().trim() );
		   }
	      else if ( getTagPath().equals( "/bookshelf/books/book/publisher" ) ) {
	    	  books.addElement( " " + contents.toString().trim() );
		   }
	      // clean up the stack...
	      tagStack.pop();
